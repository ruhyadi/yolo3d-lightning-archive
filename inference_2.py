...
from yolov5.utils.general import LOGGER, check_img_size, check_requirements, non_max_suppression, print_args, scale_coords
...
from src.datamodules.components.kitti_dataset import generate_bins, DetectedObject
from src.utils.Math import *
from src.utils.Plotting import *
from src.utils import ClassAverages
from src.models.components.backbone import ResNet, ResNet18, VGG11
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / './data/demo/images', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--calib_file', type=str, default=ROOT / 'data/global_calib.txt', help='Calibration file or path')
    ...
    parser.add_argument('--output_path', type=str, default=ROOT / './outputs', help='Save output pat')
